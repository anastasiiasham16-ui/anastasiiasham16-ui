...
**Junior+ Data / Product / Marketing Analyst** Я занимаюсь продуктовой и маркетинговой аналитикой, помогая бизнесу находить точки роста на основе данных. Специализируюсь на исследованиях для GameDev, FoodTech и E-commerce.

---

### 🔧 Мой стек
* **Языки программирования:** Python (Pandas, NumPy, SciPy, Statsmodels), SQL (PostgreSQL, ClickHouse, SQLite3)
* **Инструменты & BI:** Tableau, Power BI, DataLens, Looker Studio, Excel (Pivot Tables, Слайсеры, KPI-карты)
* **Аналитический инструментарий:** А/В-тестирование (Z-тесты, Bootstrap), Когортный анализ (Retention Rate), RFM-сегментация, продуктовые и маркетинговые метрики (LTV, CAC, ARPU, воронки)
